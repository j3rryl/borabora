...
//Fuctions covered here are res.cal() function that will fire up the page once it loads, res.pick() function thats fires up once the user clicks on a date on the calender and updates the html to the newly selected date and res.save() thats the submit and process the reservation.